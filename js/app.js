...
// Универсальная функция для рендеринга блоков и обработки вкладок
...
// Инициализация вкладок и рендеринг контента
initializeTabs();

document.addEventListener("DOMContentLoaded", () => {
  const container = document.querySelector(".blobs-container");
  const numBlobs = 30; // Количество пятен
  ...
  for (let i = 0; i < numBlobs; i++) {
    ...
    // Размер и позиции в пределах body
  ...
  // Обновление высоты контейнера при изменении контента
